...
using AdmissionsWebsite.Models;
...
namespace AdmissionsWebsite
{
    ...
    // First, Adding a role manager, follow chapter7 page189
    ...
    // Third, Create an Admin user and Admin role, follow chapter7 page190
    public class ApplicationDbInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext>
    {
        ...
        public static void InitializeIdentityForEF(ApplicationDbContext db)
        {
            ...
            const string name = "admin@admission.gmu.edu";
